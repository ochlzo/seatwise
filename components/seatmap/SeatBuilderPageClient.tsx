...
import { SelectionPanel, Toolbar as ModeToolbar } from "@/components/seatmap/UIOverlays";
...
const SeatmapCanvas = dynamic(() => import("@/components/seatmap/SeatmapCanvas"), {
  ssr: false,
  loading: () => (
...
export function SeatBuilderPageClient() {
