...
export function LoginForm({
  ...
  return (
    <div
      className={cn(
        "mx-auto flex w-full max-w-md flex-col gap-6 md:max-w-5xl",
        className,
      )}
      {...props}
    >
      <Card className="overflow-hidden p-0">
        <CardContent className="grid p-0 md:min-h-[620px] md:grid-cols-[1.05fr_1.2fr]">
          <form
            className="flex flex-col gap-6 p-6 md:justify-center md:p-10"
            onSubmit={handleSubmit}
          >
            <div className="w-full md:mx-auto md:max-w-md">
              <FieldGroup>
                <div className="mb-5 flex flex-col items-center gap-2 text-center md:mb-4">
